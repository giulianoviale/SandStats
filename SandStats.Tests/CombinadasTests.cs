...
namespace SandStats.Tests
{
    public class CombinadasTests
    {
        ...
        [
            ...
            new() { Id =  9, FundamentoCargado = Fundamento.Bloqueo,   CalidadCargada = Calidad.Slash,         FundamentoDerivado = Fundamento.Ataque, CalidadDerivada = Calidad.Exclamativa   },
            ...
            new() { Id = 14, FundamentoCargado = Fundamento.Defensa,   CalidadCargada = Calidad.Exclamativa,   FundamentoDerivado = Fundamento.Ataque, CalidadDerivada = Calidad.Exclamativa   },
        ...
        [
            ...
            [Fundamento.Bloqueo,   Calidad.Slash,         Fundamento.Ataque, Calidad.Exclamativa  ],
            ...
            [Fundamento.Defensa,   Calidad.Exclamativa,   Fundamento.Ataque, Calidad.Exclamativa  ],
